...
(function ($) {
    ...
    w2grid.prototype = {
        ...
        operators: { // for search fields
            "text"    : ['is', 'begins', 'contains', 'ends', { oper: 'null', text: 'is null' }, { oper: 'not null', text: 'is not null' }],
...
//                    break;
                ...
                case 'null':
                    fld1.hide();
                    fld1.val(' '); // need to insert something for search to activate
                    fld1.change();
                    break;
            }
        },
            ...
            setTimeout(function () {
                ...
                var ajaxOptions = {
                    ...
                    xhr : function() {
                        ...
                        // upload
						if(isIE()) return xhr;   ///Added by GuoHai to handle IE9 use case.
